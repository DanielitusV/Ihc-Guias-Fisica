...
const nav = [
  ...
  { to: "/cuentas", label: "Cuentas", icon: "Bs" },
  ...
  return (
    <div className="min-h-screen p-4 md:p-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="leading-tight">
              <div className="text-sm font-semibold">
                Centro de Estudiantes de Fisica · Guias 2026
              </div>
              <div className="text-[11px] opacity-90">
                UMSS · Facultad de Ciencias y Tecnologia - Panel del encargado
              </div>
            </div>
          </div>
          <div />
            ...
            <nav className="flex flex-col gap-1">
              {nav.map((n) => {
                ...
                return (
                  ...
                  >
                    <span className="w-5 text-center text-sm font-semibold">{n.icon}</span>
                    {n.label}
                  </Link>
                );
              })}
      ...
      <p className="mx-auto mt-3 max-w-[1400px] text-center text-[11px] text-white/85 drop-shadow">
        UXploradores · Interaccion Humano-Computadora · I-2026
      </p>
    </div>
  );
}
