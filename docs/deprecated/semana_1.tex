...
El proyecto no busca crear una tienda virtual ni reemplazar la venta presencial. Su propósito es mejorar el apoyo administrativo mediante una interfaz simple, clara y fácil de usar. Esto se relaciona directamente con los principios de diseño centrado en el usuario, ya que se enfoca en la experiencia del usuario, la reducción de carga cognitiva y la claridad en la interacción.
